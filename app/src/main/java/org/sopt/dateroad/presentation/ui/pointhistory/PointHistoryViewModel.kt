...
@HiltViewModel
class PointHistoryViewModel @Inject constructor() : BaseViewModel<PointHistoryContract.PointHistoryUiState, PointHistoryContract.PointHistorySideEffect, PointHistoryContract.PointHistoryEvent>() {
