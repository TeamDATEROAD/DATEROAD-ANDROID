...
class AuthRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun deleteWithdraw(userId: Int, requestWithdrawDto: RequestWithdrawDto) =
        authService.deleteWithdraw(userId = userId, requestWithdrawDto = requestWithdrawDto)
}
